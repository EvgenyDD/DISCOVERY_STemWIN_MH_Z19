...
#define  LCD_PIXEL_HEIGHT   ((uint16_t)400)

/* PORTRAIT OR LANDSCAPE */
#define DISP_ORIENT PORTRAIT

#if 0//DISP_ORIENT==LANDSCAPE
#define LCD_SWAP_XY 1 //now LCD_SWAP_XY=1
#else
...
void _fill_multiple(uint16_t *color, long pix);
