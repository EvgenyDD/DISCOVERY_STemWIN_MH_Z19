...
void FSMC_Init()
{
	...
	FSMC_NORSRAMTimingInitStructureRead.FSMC_AddressSetupTime = 0;//3
	FSMC_NORSRAMTimingInitStructureRead.FSMC_AddressHoldTime = 0;//0
	FSMC_NORSRAMTimingInitStructureRead.FSMC_DataSetupTime = 0;//15
	...
	FSMC_NORSRAMTimingInitStructureWrite.FSMC_AddressSetupTime = 0;//4
	FSMC_NORSRAMTimingInitStructureWrite.FSMC_AddressHoldTime = 0;//0
	FSMC_NORSRAMTimingInitStructureWrite.FSMC_DataSetupTime = 0;//5
...
void ILI9327_PixelDraw(uint16_t x, uint16_t y, uint16_t color)
{
	setXY(x, y, x, y);
	LCD->LCD_RAM = color;
}
