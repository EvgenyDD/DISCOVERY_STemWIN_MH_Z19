...
void ILI9327_Init()
{
	...
	ILI9327_WriteData(0x04);
	ILI9327_WriteData(0x67);
	ILI9327_WriteData(0x35);
	ILI9327_WriteData(0x04);
	ILI9327_WriteData(0x08);
	ILI9327_WriteData(0x06);
	ILI9327_WriteData(0x24);
	ILI9327_WriteData(0x01);
	ILI9327_WriteData(0x37);
	ILI9327_WriteData(0x40);
	ILI9327_WriteData(0x03);
	ILI9327_WriteData(0x10);
	ILI9327_WriteData(0x08);
	ILI9327_WriteData(0x80);
	ILI9327_WriteData(0x00);
...
void ILI9327_WriteData(uint16_t paramValue)
{
	LCD->LCD_RAM = paramValue;
}

uint16_t ILI9327_ReadData()
{
	return LCD->LCD_RAM;
}


void ILI9327_ReadDataMultiple(uint16_t *pData, long NumItems)
{
	while(NumItems--)
		*pData++ = LCD->LCD_RAM;
}
...
void setXY(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2)
{
	...
	ILI9327_WriteData(x1>>8);
	ILI9327_WriteData(x1);
	ILI9327_WriteData(x2>>8);
	ILI9327_WriteData(x2);

	ILI9327_WriteCom(0x2b);		//set_page_address
	ILI9327_WriteData(y1>>8);
	ILI9327_WriteData(y1);
	ILI9327_WriteData(y2>>8);
	ILI9327_WriteData(y2);
...
void _fill_multiple(uint16_t *pData, long pix)
{
	while(pix--)
		LCD->LCD_RAM = *pData++;
}
