...
void hard_fault_handler_c (long * hardfault_args)
{
...
static void Default_Handler1(void)
{
	/* Go into an infinite loop. */
	while (1)
	{
...
static void Default_Handler7(void)
{
	/* Go into an infinite loop. */
	while (1)
	{
...
static void Default_Handler8(void)
{
	/* Go into an infinite loop. */
	while (1)
	{
...
static void Default_Handler9(void)
{
	/* Go into an infinite loop. */
	while (1)
	{
