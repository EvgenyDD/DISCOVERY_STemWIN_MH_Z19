...
const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
    ...
    {EDIT_CreateIndirect, 0, GUI_ID_EDIT0, 0, 37, 200, 25},
    {EDIT_CreateIndirect,
...
static void setFreq(uint32_t freq)
{
    ...
    base_timer.TIM_Prescaler = psc - 1;              // �������� �������
    base_timer.TIM_Period = arr - 1;                 // ������
...
void GraphCallback(WM_MESSAGE *pMsg)
{
    ...
    TIM_Cmd(TIM1, genEnable ? ENABLE : DISABLE); // ��������� ����
        ...
        case WM_NOTIFICATION_VALUE_CHANGED:
            ...
            case GUI_ID_CHECK5:
                ...
                GRAPH_SetBorder(hItem,
                                CHECKBOX_IsChecked(
                                    WM_GetDialogItem(hDlg, GUI_ID_CHECK2)) *
                                    40,
                                CHECKBOX_IsChecked(
                                    WM_GetDialogItem(hDlg, GUI_ID_CHECK3)) *
                                    5,
                                CHECKBOX_IsChecked(
                                    WM_GetDialogItem(hDlg, GUI_ID_CHECK4)) *
                                    5,
                                CHECKBOX_IsChecked(
                                    WM_GetDialogItem(hDlg, GUI_ID_CHECK5)) *
                                    5);
